...
from config import (
    VALIDATION_SET, system_instruction, extra_system_instruction, 
    MODEL_NAME, TXT_LOG_FILE, TIMING_LOG_FILE, MAX_NEW_TOKENS, PARQUET_OUTPUT, ADAPTER_PATH
)
...
print("\n" + "=" * 60)
print("VALIDATION COMPLETE (FINE-TUNED MODEL)")
print("=" * 60)
